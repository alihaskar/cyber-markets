...
/**
 * Bittrex exchange ws messages parser.
 *
 * Bittrex sends instead of trade baseamount -> number of lots. Each {@link TokensPairInitializer} contains lot size.
 *
 */
class BittrexTradesMessageParser(
...
class BittrexOrdersMessageParser(
        private val channelSymbolForTokensPair: Map<String, TokensPairInitializer>
) : SaveExchangeMessageParser() {
