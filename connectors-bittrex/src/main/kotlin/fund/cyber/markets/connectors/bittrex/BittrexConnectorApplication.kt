...
import fund.cyber.markets.connectors.bittrex.connector.BittrexConnectionProvider
...
//    supportedTradesEndpoints.forEach { exchange ->
        concurrent {
            val bittrexEndpoint =
                    BittrexTradesEndpoint(wsConnectionUrl = BittrexConnectionProvider().getConnectionToken())
